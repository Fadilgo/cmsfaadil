                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item <?php if($w == 'galeri'){echo 'active';} ?>">
    ...
    <div class="regular-page-wrap section-padding-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8" style="background:#323a45;">
                    <div class="page-content">
                        <div class="title d-flex justify-content-center">
                            <h1 class="title" style="color:#ffff;"> Galeri </h1>
                            <hr>
                        </div>
                    <?php foreach ($galeri as $ga){ ?>
                        <img style="width:45%; height:auto;" class="foto m-2" src="<?= base_url('template/upload/galeri/'.$ga['foto']) ?>" alt="">
                        <?php } ?>
                    </div>
                </div>
            </div>
